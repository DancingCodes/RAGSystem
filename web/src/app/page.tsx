    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        >
          ...
          <div className="mt-2 text-xs text-zinc-600">创建/查看知识库</div>
        </Link>
        <Link
          href="/upload"
          className="rounded-xl border border-zinc-200 bg-white p-5 hover:border-zinc-300"
        >
          ...
          <div className="mt-2 text-xs text-zinc-600">选择知识库并上传文件</div>
        </Link>
        <Link
          href="/chat"
          className="rounded-xl border border-zinc-200 bg-white p-5 hover:border-zinc-300"
        >
          ...
          <div className="mt-2 text-xs text-zinc-600">基于向量检索进行回答</div>
        </Link>
      </div>
    </div>
  );
